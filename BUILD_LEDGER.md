...
- Authenticated Move-board release gate: commits `4ec39a6`, `d9630ec`, and `38d032d`; GitHub Actions run `30324312423` passed install, lint, typecheck, 36 automated tests, 35 Convex-focused tests, Convex validation, production build, fifteen authenticated Chromium journeys, and foundation evidence on 2026-07-27. The selected Mission exposes room-scoped Move creation, title and intent editing, dependency selection, valid lifecycle transitions, keyboard activation, reactive state, and reload persistence.
...
- CI and production build: passed in GitHub Actions run `30324312423`
