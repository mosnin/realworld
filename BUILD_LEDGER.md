...
- Calls now have a durable owner-operated canvas journey. Participant capacity, joining, responses, deadlines, resolution summaries, and two-context Call collaboration are not implemented or claimed.
...
- CI and production build: passed in GitHub Actions run `30326053820`
- Signed-in responsive shell: passed with local ephemeral Convex Auth
- Authorization boundaries: forty-six automated tests pass locally and in hosted CI across Mission, Constitution, Move, Call, membership, invitation, room scopes, lifecycle, expiry, dependencies, OCC, and idempotency behavior
