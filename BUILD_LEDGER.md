...
- CI and production build: passed in GitHub Actions run `30331844498`
- Signed-in responsive shell: passed with local ephemeral Convex Auth
- Authorization boundaries: sixty-two automated tests pass locally and in hosted CI across Mission, Constitution, Move, Call administration, participation and response history, Fracture recovery, Proof verification, Pulse history, membership, invitation, room scopes, lifecycle, expiry, dependencies, capacity, OCC, and idempotency behavior
