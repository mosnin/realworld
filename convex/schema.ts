...
export default defineSchema({
  ...
  calls: defineTable({
    ...
    creatorDisplayNameAtAction: v.optional(v.string()),
    creatorTypeAtAction: v.optional(principalType),
    creatorRoleAtAction: v.optional(membershipRole),
    title: v.string(),
    detail: v.string(),
  ...
  callParticipants: defineTable({
    ...
    missionId: v.id("missions"),
    principalId: v.id("principals"),
    displayNameAtJoin: v.optional(v.string()),
    typeAtJoin: v.optional(principalType),
    roleAtJoin: v.optional(membershipRole),
  ...
  callResponseRevisions: defineTable({
    ...
    principalId: v.id("principals"),
    displayNameAtAction: v.optional(v.string()),
    typeAtAction: v.optional(principalType),
    roleAtAction: v.optional(membershipRole),
    revision: v.number(),
    response: v.string(),
  ...
  fractures: defineTable({
    ...
    reporterDisplayNameAtAction: v.optional(v.string()),
    reporterTypeAtAction: v.optional(principalType),
    reporterRoleAtAction: v.optional(membershipRole),
    title: v.string(),
    detail: v.string(),
  ...
  proofs: defineTable({
    ...
    submitterDisplayNameAtAction: v.optional(v.string()),
    submitterTypeAtAction: v.optional(principalType),
    submitterRoleAtAction: v.optional(membershipRole),
    title: v.string(),
    claim: v.string(),
    ...
    verifierDisplayNameAtAction: v.optional(v.string()),
    verifierTypeAtAction: v.optional(principalType),
    verifierRoleAtAction: v.optional(membershipRole),
